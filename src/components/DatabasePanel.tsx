  ...
  return (
    <div className="settings-section">
      ...
      <section className="settings-card">
        <h3 className="settings-card-heading">Paths</h3>
      ...
      <section className="settings-card">
        <h3 className="settings-card-heading">Maintenance</h3>
        <div className="settings-pref-row">
          <div className="settings-pref-label">
            <span>Snapshot</span>
            <span className="muted compact">Capture today's state for the trend charts.</span>
          </div>
          <div className="settings-pref-options">
            <button
              className="chip"
        ...
        <div className="settings-pref-row">
          <div className="settings-pref-label">
            ...
            <span className="muted compact">Pick a different folder; FRAME copies the DB and re-points to the new path.</span>
          </div>
          <div className="settings-pref-options">
            <button
              className="chip"
        ...
        <div className="settings-pref-row">
          <div className="settings-pref-label">
            <span>Export</span>
            <span className="muted compact">Save a copy of the current DB to a file.</span>
          </div>
          <div className="settings-pref-options">
            <button
              className="chip"
        ...
        <div className="settings-pref-row">
          <div className="settings-pref-label">
            <span>Import</span>
            <span className="muted compact">Replace the current DB with a chosen file. Backed up first.</span>
          </div>
          <div className="settings-pref-options">
            <button
              className="chip"
      ...
      <section className="settings-card">
        <h3 className="settings-card-heading">Backups</h3>
        {backups.length === 0 ? (
